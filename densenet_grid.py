...
# available layers (40,10): 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 148, 152
# available layers (100,10): 268, ..., 392

saved_models_dir = '/home/eo41/continuous_cache_image_recognition/saved_models/'

# ---------------------------------------------------------------------------
# Setup hyperparams: lambda, theta
theta_range = np.linspace(10.0, 90.0, 33)
lambda_range = np.linspace(0.1, 0.9, 33)
TT, LL = np.meshgrid(theta_range,lambda_range)
TT = TT.flatten()
LL = LL.flatten()
...
# Score trained model.
# The following is a dummy compile, since we'll only evaluate the model
...
sio.savemat('DenseNet_v%d_jobidx%i.mat' % (v,job_idx), {'mem_acc': test_acc,
                                                        'no_mem_acc': scores[1],
                                                        'theta': theta,
                                                        'lmbd': lmbd})
