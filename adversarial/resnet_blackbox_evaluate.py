...
adv_imgs_dir = 'adv_imgs_resnet32_baseline/'
...
# Load the adversarial images generated from the baseline model (nomem) and their labels
if attack_name == 'fgsm':
    x_val = sio.loadmat(adv_imgs_dir+'ResNet_fgsm_nomem_32_adversarials.mat')['adv_imgs']
    y_val = sio.loadmat(adv_imgs_dir+'ResNet_fgsm_nomem_32_adversarials.mat')['successful_labels']
elif attack_name == 'ifgsm':
    x_val = sio.loadmat(adv_imgs_dir+'ResNet_ifgsm_nomem_32_adversarials.mat')['adv_imgs']
    y_val = sio.loadmat(adv_imgs_dir+'ResNet_ifgsm_nomem_32_adversarials.mat')['successful_labels']
elif attack_name == 'sp':
    x_val = sio.loadmat(adv_imgs_dir+'ResNet_sp_nomem_32_adversarials.mat')['adv_imgs']
    y_val = sio.loadmat(adv_imgs_dir+'ResNet_sp_nomem_32_adversarials.mat')['successful_labels']
elif attack_name == 'gb':
    x_val = sio.loadmat(adv_imgs_dir+'ResNet_gb_nomem_32_adversarials.mat')['adv_imgs']
    y_val = sio.loadmat(adv_imgs_dir+'ResNet_gb_nomem_32_adversarials.mat')['successful_labels']
...
sio.savemat('ResNet%d_blackbox_evaluate_gb.mat' %depth, {'mem_acc': test_acc, 'no_mem_acc': scores[1], 'theta': theta, 'lmbd': lmbd})