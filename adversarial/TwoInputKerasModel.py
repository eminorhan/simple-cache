...
class TwoInputKerasModel(DifferentiableModel):
    ...
    def __init__(
        ...
        self._loss_fn = K.function(
            [images_input, label_input, aux_learning_phase],
            [loss])
        self._batch_pred_fn = K.function(
            [images_input, aux_learning_phase], [predictions])
    ...
    def batch_predictions(self, images):
        predictions = self._batch_pred_fn([self._process_input(images),self.aux_lp])
