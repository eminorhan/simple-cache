"""Hyperparameter search over theta for the DenseNet CacheOnly models.
"""
...
# Setup hyperparam theta (note lambda is set to 1.0)
theta_range = np.linspace(50.0,100.0,10)
...
sio.savemat('DenseNet_v%d_justmem_jobidx%i.mat' % (v,job_idx), {'mem_acc': test_acc,
                                                        'no_mem_acc': scores[1],
                                                        'theta': theta,
                                                        'lmbd': lmbd})