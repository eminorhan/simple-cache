"""Hyperparameter search over theta and lambda for the ResNet cache models.
"""
...
# ---------------------------------------------------------------------------
# Setup hyperparam grid: lambda, theta
...
sio.savemat('ResNet%d_jobidx%i.mat' % (depth,job_idx), {'mem_acc': test_acc,
                                                        'no_mem_acc': scores[1],
                                                        'theta': theta,
                                                        'lmbd': lmbd})